    ...
    suggestions: [
      ...
      },
      {
        ...
        items: [
          {
            title: "$A",
            description: "(Column) Date - Date ",
          },
          {
            title: "&A",
            description: "(Position) Date - Date ",
          },
          {
            title: "$B",
            description: "(Column) Budget - Number ",
          },
          {
            title: "&B",
            description: "(Position) Budget - Number ",
          },
          {
            title: "$C",
            description: "(Column) Actual - Number ",
          },
          {
            title: "&C",
            description: "(Position) Actual - Number ",
          },
        ],
      },
    ],
...
export const group = {
  args: {
    placeholder:
      "Try type one of these function name(SUM/AVG/COUNT) or any variable type(Number/String/Boolean).",
    suggestions: [
      {
        type: "Function",
        color: "blue",
...
export const style = {
  ...
  styles: {
    listItem: (defaultStyles, { groupIndex, suggestions }) => ({
      ...defaultStyles,
    ...
    suggestions: [
      {
        ...
        items: [
          ...
          },
          {
            title: "CONTAINS",
            description:
              "Checks to see if a string is a substring of another string",
