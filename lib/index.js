...
function (_Component) {
  ...
  function FormulaBar(_props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FormulaBar).call(this, _props));
    ...
    value: function render() {
      ...
      var _styles$container = styles.container,
        ...
        return styles;
          ...
          _styles$listContainer = styles.listContainer,
          listContainerStyle = _styles$listContainer === void 0 ? function (styles) {
        return styles;
      } : _styles$listContainer,
      ...
      return _react["default"].createElement("div", {
        ...
        type: type,
        onBlur: (0, _lodash.partial)(onBlur, value)
...
_defineProperty(FormulaBar, "defaultProps", {
  ...
  styles: {
    ...
    listContainer: function listContainer(styles) {
      return styles;
    },
