    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        dangerouslySetInnerHTML: {
          __html: function () {
            var formula = value;
            (0, _lodash.each)(suggestions, function (_ref7) {
              var color = _ref7.color,
                  items = _ref7.items;
              (0, _lodash.each)(items, function (_ref8) {
                var title = _ref8.title;
                formula = (0, _lodash.replace)((0, _lodash.replace)(formula, new RegExp("\\b(".concat((0, _lodash.replace)(title, /[|\\{}()[\]^$+*?.-]/g, '\\$&'), ")\\b"), 'g'), "<span style=\"color:".concat(color, "\">$1</span>")), '  ', ' &nbsp;');
              });
            });
            return formula;
          }()
        ...
        switch (display) {
          ...
          case 'suggest':
            return /*#__PURE__*/_react["default"].createElement("dl", {
            ...
            }, (0, _lodash.map)(results, function (_ref9, groupIndex) {
              var type = _ref9.type,
                  items = _ref9.items;
              ...
              }, type), (0, _lodash.map)(items, function (_ref10, itemIndex) {
