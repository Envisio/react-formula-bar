...
var FormulaBar = /*#__PURE__*/function (_Component) {
  ...
  function FormulaBar(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "generateSuggestions", function (event) {
      var suggestions = _this.props.suggestions;
    ...
    _defineProperty(_assertThisInitialized(_this), "onClickSuggestion", function (groupIndex, itemIndex, event) {
      event.preventDefault();
